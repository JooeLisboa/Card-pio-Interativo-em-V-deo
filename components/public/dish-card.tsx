...
import { ArrowRight, CircleOff, Flame } from "lucide-react";
...
export function DishCard({ restaurantSlug, tableCode, dish }: DishCardProps) {
  const href = `/menu/${restaurantSlug}/dish/${dish.slug}${tableCode ? `?table=${tableCode}` : ""}`;
    ...
    <article className="surface overflow-hidden">
      ...
      <div className="space-y-4 p-5">
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="rounded-2xl bg-stone-950 px-3 py-2 text-sm font-bold text-white">
